...
*                   
*/
__int8_t r_firmware_rev_Si7021(void);
...
*                   
*/
__int8_t VDD_warning_Si7021(void);
...
*                   
*/
__int8_t r_single_Si7021(float* data, Si7021_measurement_type_t type);
...
*                   
*/
__int8_t r_both_Si7021(float* humidity, float* temperature);
...
*                   
*/
__int8_t set_resolution_Si7021(Si7021_resolution_t resolution);
...
*/
__int8_t set_heater_current_Si7021(__uint8_t current);
...
* NOTES :          Values are in mA and VDD assumed to be 3.3 V.
*/
__int8_t r_heater_current_Si7021(void);
...
* NOTES :
*/
__int8_t enable_heater_Si7021(__uint8_t val);
...
* NOTES :
*/
__int8_t get_register(Si7021_registers_t reg, __uint8_t* rv);
